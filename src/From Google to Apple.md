...
iPhone makes clear the differences in the Google and Apple attitudes user identity. In Google a user is a Google account; an Android phone is a window into it. In Apple a user is an iPhone, and the iPhone is possibly synchronized with an Apple account.
