...
Reminders is one of the best-designed apps on iOS. Reminders can be scheduled to “pop” at a date, a date and time, a location, and/or when messaging `$PERSON`. I use the “Today” view when in-app, which shows any reminder that’s popped or that has no pop trigger.
