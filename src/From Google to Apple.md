...
Instead, I’ve carried it room to room for two years now. It’s fulfilled the minimum goal and has even replaced some light computer usage, such as writing. The app ecosystem better understands the tablet form factor; many apps use it to display more information or at least differently laid out information. The multitasking experience is opinionated but helpful. Opening multiple windows per app is a big leap towards not feeling like a phone, but I’ve only seen native apps support it.
