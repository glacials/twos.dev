...
The more native apps I use on iOS, the better the UX gets. For example, you can use multi-touch to drag-and-drop items between apps, such as from Photos into Mail (one finger holding the items, one switch apps). Third-party apps only implement this functionality sometimes.
