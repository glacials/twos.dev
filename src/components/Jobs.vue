<template>
  <b-container>
    ...
    <b-media no-body>
      <b-media-aside class="mr-0 mr-md-3">
      ...
      <b-media-body>
        <h5 class="mb-0 justify-content-between d-flex">
          <span>
            <b-link href="https://splits.io" class="text-dark">Splits.io</b-link>
            <small class="text-muted text-nowrap">2019 - present</small>
    ...
    <b-media no-body>
      ...
      <b-media-body>
        <h5 class="mb-0 justify-content-between d-flex">
          <span>
            <b-link href="https://twitch.tv" class="text-dark">Twitch</b-link>
            <small class="text-muted text-nowrap">2014 - 2019</small>
    ...
    <b-media no-body>
      ...
      <b-media-body>
        <h5 class="mb-0 justify-content-between d-flex">
          <span>
            <b-link href="https://llnl.gov" class="text-dark">Lawrence Livermore National Laboratory</b-link>
            <small class="text-muted text-nowrap">2010 - 2013</small>
